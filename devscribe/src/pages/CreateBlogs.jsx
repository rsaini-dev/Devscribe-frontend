        ...
        <div className="w-full md:w-[300px] flex flex-col bg-zinc-900 rounded-lg p-4 space-y-4 border border-zinc-700">
          <div className="relative">
            <input
              ...
              className="peer block w-full appearance-none bg-transparent border-b border-zinc-500 px-3 pt-5 pb-2 text-white focus:outline-none focus:ring-0"
            />
          </div>
          ...
          <div className="mt-2">
            ...
            />
            <div className="mt-4 max-w-full h-40 w-full rounded-md border border-zinc-700 flex items-center justify-center overflow-hidden bg-zinc-800 text-white text-sm">
              {imagePreview ? (
                <img
                  src={imagePreview}
                  alt="Preview"
          ...
          <div className="flex justify-center space-x-4 mt-2">
            ...
            {/* Save Button */}
            <button className="px-5 py-2 rounded-3xl bg-indigo-600 text-white hover:bg-indigo-500 transition">
              SAVE
            </button>
          </div>
        </div>
